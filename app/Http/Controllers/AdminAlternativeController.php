...
class AdminAlternativeController extends Controller
{
  ...
  public function store(AlternativeStoreRequest $request)
  {
    ...
    return redirect('/dashboard/alternatives')
      ->with('Berhasil', 'Alternatif Berhasil Ditambahkan!');
  }
  ...
  public function edit(Alternative $alternative)
  {
    ...
    return view('dashboard.alternative.edit', [
      'title'        => "Edit Nilai $alternative->name's",
  ...
  public function update(AlternativeUpdateRequest $request, Alternative $alternative)
  {
    ...
    return redirect('/dashboard/alternatives')
      ->with('Berhasil', 'Alternatif Berhasil Diperbarui!');
  }
  ...
  public function destroy(Alternative $alternative)
  {
    ...
    return redirect('/dashboard/alternatives')
      ->with('Berhasil', 'Alternatif Berhasil Dihapus!');
  }
  public function showEigenVectors() {
    $criterias = Criteria::all();
    $alternatives = Alternative::all();
    return view('admin.alternatives.eigen_vectors', compact('criterias', 'alternatives'));
}
